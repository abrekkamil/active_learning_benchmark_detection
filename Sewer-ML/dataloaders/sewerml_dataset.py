...
class MultiLabelDataset(Dataset):
    def __init__(self, img_dir, labels_path, val_list = None, train_list = None, image_transform=None, loader=default_loader, onlyDefects=False, known_labels=0,testing=False,split='Train'):
